...
<div data-gr-c-s-loaded="true">
  ...
  <div style="width:620px; margin-left:auto; margin-right:auto; text-align:center;">
    ...
    <form
      id="button"
      action="http://intranet.info53.com/directories/policycenter/Portal/default.asp"
      method="get"
    >
      <input type="submit" value="Go to the Fifth Third Bank Policy Center" formtarget="_blank" />
    </form>
    <p></p>
    <hr />
    ...
    <div v-if="this.hasSubmitted === false ? true : false">
        <form 
                ...
                <div class="form-elements">
                    <textarea rows="10" cols="70" name="reason" required></textarea>
                    <input style="display: none" name="url" value="">
                    <input style="display: none" name="url-category" value="">
                    <input style="display: none" name="kind" value="">
                    <input style="display: none" name="employee-id" value="">
                    <input style="display: none" name="workstation-id" value="">
                    <input style="display: none" name="ip-address" value="">
                    <input style="display: none" name="date" value="">
                    <br /><br />
     ...
     <div v-if="this.hasSubmitted === true ? true : false">
                    ...
                    <h2><em>Thanks</em> for contacting us! Check back here soon!
                    </h2>
                </div>
            <p>
